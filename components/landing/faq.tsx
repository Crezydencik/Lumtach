  ...
  return (
    <section id='faq' className="py-20 bg-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-6xl font-mono text-center mb-16 font-bold text-white">{t('faq.title')}</h2>
                ...
                <div key={id} className="border-b border-gray-800">
                  ...
                  >
                    ...
                    <div className="flex-shrink-0">
                      {openIndex === id ? (
                        <div className="bg-[#A6EB53] p-2 rounded-[4px]">
                          <Minus className="w-5 h-5 text-black" />
                        </div>
                      ) : (
                        <div className="bg-gray-800 p-2 rounded-[4px]">
