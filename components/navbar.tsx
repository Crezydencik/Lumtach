      ...
      <nav className="fixed w-full z-50 bg-black">
        <div className="flex items-center justify-between h-20 px-6">
          ...
          <div className="flex items-center space-x-4">
            <a href="#contact" className="bg-[#A6EB53] text-black hover:bg-[#96D44B] px-6 py-2 rounded-full text-sm font-mono">
              {t('navbar.contact')}
            </a>
          ...
          >
            <div className="flex flex-col h-full justify-between p-8">
              <div className="space-y-8">
                ...
                <Link href="#about" className="block text-white hover:text-[#A6EB53] text-xl font-mono">
                  {t('navbar.about')}
                </Link>
                <Link href="#services" className="block text-white hover:text-[#A6EB53] text-xl font-mono">
                  {t('navbar.services')}
                </Link>
